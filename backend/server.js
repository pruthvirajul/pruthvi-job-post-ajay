...
app.use(cors({
  origin: [
    ...
    "http://16.171.177.74:8020",
    "http://16.171.177.74:5500",
    "http://16.171.177.74:8021",
    "http://16.171.177.74:8034",
    "http://16.171.177.74:8035"
...
// Start server
app.listen(port, () => {
  console.log(`Server running on http://16.171.177.74:${port}`);
});
